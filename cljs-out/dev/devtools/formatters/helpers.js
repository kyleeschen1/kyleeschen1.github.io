...
var G__47626 = devtools.prefs.pref.call(null,v);
v = G__47626;
continue;
} else {
return v;
...
}catch (e47627){var _e__33989__auto__ = e47627;
return false;
}})();
...
}catch (e47629){var _e__33989__auto__ = e47629;
return false;
}})();
...
}catch (e47631){var _e__33989__auto__ = e47631;
return false;
}}
}
});
...
var vec__47633 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__47633,(0),null);
var name = cljs.core.nth.call(null,vec__47633,(1),null);
...
return cljs.core.some.call(null,(function (p1__47636_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__47636_SHARP_);
}),template);
});
