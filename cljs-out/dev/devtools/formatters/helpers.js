...
var G__18664 = devtools.prefs.pref.call(null,v);
v = G__18664;
continue;
} else {
return v;
...
}catch (e18665){var _e__18405__auto__ = e18665;
return false;
}})();
...
}catch (e18667){var _e__18405__auto__ = e18667;
return false;
}})();
...
}catch (e18669){var _e__18405__auto__ = e18669;
return false;
}}
}
});
...
var vec__18671 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__18671,(0),null);
var name = cljs.core.nth.call(null,vec__18671,(1),null);
...
return cljs.core.some.call(null,(function (p1__18674_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__18674_SHARP_);
}),template);
});
