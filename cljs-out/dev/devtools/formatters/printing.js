...
var len__4864__auto___47667 = arguments.length;
var i__4865__auto___47668 = (0);
while(true){
if((i__4865__auto___47668 < len__4864__auto___47667)){
args__4870__auto__.push((arguments[i__4865__auto___47668]));

var G__47669 = (i__4865__auto___47668 + (1));
i__4865__auto___47668 = G__47669;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq47664){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47665,G__47666,seq47664__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__47670_SHARP_){
return (!((cljs.core.meta.call(null,p1__47670_SHARP_) == null)));
})))){
...
var map__47671 = opts;
var map__47671__$1 = cljs.core.__destructure_map.call(null,map__47671);
var markup_db = cljs.core.get.call(null,map__47671__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e47672){var _e__33989__auto__ = e47672;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e47674){var _e__33989__auto__ = e47674;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__47676 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__47677 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__47677);
...
var map__47678 = opts;
var map__47678__$1 = cljs.core.__destructure_map.call(null,map__47678);
var markup_db = cljs.core.get.call(null,map__47678__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__47676);
}});
...
var temp__5718__auto___47682 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___47682)){
var managed_print_level_47683 = temp__5718__auto___47682;
var _STAR_print_level_STAR__orig_val__47680_47684 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__47681_47685 = managed_print_level_47683;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__47681_47685);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__47679_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__47679_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__47680_47684);
}} else {
job_fn.call(null);
}
