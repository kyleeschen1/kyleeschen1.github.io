...
var len__4864__auto___34475 = arguments.length;
var i__4865__auto___34476 = (0);
while(true){
if((i__4865__auto___34476 < len__4864__auto___34475)){
args__4870__auto__.push((arguments[i__4865__auto___34476]));

var G__34477 = (i__4865__auto___34476 + (1));
i__4865__auto___34476 = G__34477;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq34472){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34473,G__34474,seq34472__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__34478_SHARP_){
return (!((cljs.core.meta.call(null,p1__34478_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__34479__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e34480){var _e__33989__auto__ = e34480;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e34482){var _e__33989__auto__ = e34482;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__34484 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__34485 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__34485);
...
var map__34486 = opts;
var map__34486__$1 = cljs.core.__destructure_map.call(null,map__34486);
var markup_db = cljs.core.get.call(null,map__34486__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__34484);
}});
...
var temp__5718__auto___34490 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___34490)){
var managed_print_level_34491 = temp__5718__auto___34490;
var _STAR_print_level_STAR__orig_val__34488_34492 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__34489_34493 = managed_print_level_34491;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__34489_34493);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__34487_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__34487_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__34488_34492);
}} else {
job_fn.call(null);
}
