...
var o18562 = temp__5718__auto__;
var temp__5718__auto____$1 = (o18562["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o18563 = temp__5718__auto____$1;
return (o18563["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__18398__auto__ = f;
return (o__18398__auto__["toString"]).call(o__18398__auto__);
} else {
return "";
}
}catch (e18564){var _ = e18564;
return "";
}});
...
try{var o__18398__auto___18566 = t;
(o__18398__auto___18566["cljs$lang$ctorPrWriter"]).call(o__18398__auto___18566,t,writer);
}catch (e18565){var __18567 = e18565;
}
...
var char_code = (function (){var o__18398__auto__ = (new String(char$));
return (o__18398__auto__["charCodeAt"]).call(o__18398__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__18398__auto__ = String;
return (o__18398__auto__["fromCharCode"]).call(o__18398__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__18568 = num_code;
switch (G__18568) {
case (1):
return (185);
...
var o__18398__auto__ = String;
return (o__18398__auto__["fromCharCode"]).call(o__18398__auto__,superscript_code);
});
/**
...
}catch (e18570){var _e__18405__auto__ = e18570;
return false;
}})())){
...
var vec__18571 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__18571,(0),null);
...
var len__4864__auto___18580 = arguments.length;
var i__4865__auto___18581 = (0);
while(true){
if((i__4865__auto___18581 < len__4864__auto___18580)){
args__4870__auto__.push((arguments[i__4865__auto___18581]));

var G__18582 = (i__4865__auto___18581 + (1));
i__4865__auto___18581 = G__18582;
continue;
} else {
}
break;
...
var ns_detector = cljs.core.nth.call(null,vec__18577,(0),null);
...
var G__18583 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__18584 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__18583;
remaining_tokens = G__18584;
continue;
}
}
break;
...
var vec__18588 = cljs.core.split_with.call(null,(function (p1__18587_SHARP_){
return cljs.core.not_EQ_.call(null,p1__18587_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__18588,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__18588,(1),null);
...
var vec__18594 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__18594,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__18594,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__18597 = cljs.core.rest.call(null,remaining_tokens);
var G__18598 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__18597;
name_tokens = G__18598;
continue;
} else {
...
var vec__18601 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__18601,(0),null);
var arity = cljs.core.nth.call(null,vec__18601,(1),null);
var vec__18604 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__18604,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__18604,(1),null);
var vec__18607 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__18607,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__18607,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__18607,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__18607,(3),null);
...
var vec__18613 = result;
var munged_ns = cljs.core.nth.call(null,vec__18613,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__18613,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__18613,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__18613,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__18613,(4),null);
var arity = cljs.core.nth.call(null,vec__18613,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__18617 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__18617,(0),null);
var args = cljs.core.nth.call(null,vec__18617,(1),null);
var vec__18620 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__18620,(0),null);
var name = cljs.core.nth.call(null,vec__18620,(1),null);
...
var G__18623 = (arity + (1));
var G__18624 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__18625){
var vec__18626 = p__18625;
var arity = cljs.core.nth.call(null,vec__18626,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__18626,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__18629_SHARP_){
return cljs.core.get.call(null,arities,p1__18629_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__18630_SHARP_){
return cljs.core.drop.call(null,(2),p1__18630_SHARP_);
}),sorted_infos);
...
var args__4870__auto__ = [];
var len__4864__auto___18637 = arguments.length;
var i__4865__auto___18638 = (0);
while(true){
if((i__4865__auto___18638 < len__4864__auto___18637)){
args__4870__auto__.push((arguments[i__4865__auto___18638]));

var G__18639 = (i__4865__auto___18638 + (1));
i__4865__auto___18638 = G__18639;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__18633){
var vec__18634 = p__18633;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__18634,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq18631){
var G__18632 = cljs.core.first.call(null,seq18631);
var seq18631__$1 = cljs.core.next.call(null,seq18631);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__18632,seq18631__$1);
}));
...
var map__18642 = options;
var map__18642__$1 = cljs.core.__destructure_map.call(null,map__18642);
var include_ns_QMARK_ = cljs.core.get.call(null,map__18642__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__18642__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__18642__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__18642__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__18643 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__18643,(0),null);
var fn_name = cljs.core.nth.call(null,vec__18643,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__18643,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__18643,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__18643,(4),null);
var arity = cljs.core.nth.call(null,vec__18643,(5),null);
...
var o__18398__auto__ = f;
return (o__18398__auto__["getBasis"]).call(o__18398__auto__);
});
/**
...
}catch (e18646){var _e__18405__auto__ = e18646;
...
var G__18647 = (obj[cljs.core.first.call(null,path)]);
var G__18648 = cljs.core.rest.call(null,path);
obj = G__18647;
path = G__18648;
continue;
} else {
...
var _STAR_ = (function (accum,p__18649){
var vec__18650 = p__18649;
var bit = cljs.core.nth.call(null,vec__18650,(0),null);
var protocol = cljs.core.nth.call(null,vec__18650,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__18653){
var vec__18654 = p__18653;
var ns = cljs.core.nth.call(null,vec__18654,(0),null);
var name = cljs.core.nth.call(null,vec__18654,(1),null);
var selector = cljs.core.nth.call(null,vec__18654,(2),null);
...
var post_process = (function (p__18658){
var vec__18659 = p__18658;
var munged_name = cljs.core.nth.call(null,vec__18659,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__18659,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__18657_SHARP_){
return (obj[cljs.core.first.call(null,p1__18657_SHARP_)]);
}),sorted_matches);
