...
var o47510 = temp__5718__auto__;
var temp__5718__auto____$1 = (o47510["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o47511 = temp__5718__auto____$1;
return (o47511["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__33982__auto__ = f;
return (o__33982__auto__["toString"]).call(o__33982__auto__);
} else {
return "";
}
}catch (e47512){var _ = e47512;
return "";
}});
...
try{var o__33982__auto___47514 = t;
(o__33982__auto___47514["cljs$lang$ctorPrWriter"]).call(o__33982__auto___47514,t,writer);
}catch (e47513){var __47515 = e47513;
}
...
var char_code = (function (){var o__33982__auto__ = (new String(char$));
return (o__33982__auto__["charCodeAt"]).call(o__33982__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__33982__auto__ = String;
return (o__33982__auto__["fromCharCode"]).call(o__33982__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__47516 = num_code;
switch (G__47516) {
case (1):
return (185);
...
var o__33982__auto__ = String;
return (o__33982__auto__["fromCharCode"]).call(o__33982__auto__,superscript_code);
});
/**
...
}catch (e47518){var _e__33989__auto__ = e47518;
return false;
}})())){
...
var vec__47519 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__47519,(0),null);
...
var len__4864__auto___47528 = arguments.length;
var i__4865__auto___47529 = (0);
while(true){
if((i__4865__auto___47529 < len__4864__auto___47528)){
args__4870__auto__.push((arguments[i__4865__auto___47529]));

var G__47530 = (i__4865__auto___47529 + (1));
i__4865__auto___47529 = G__47530;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__47524){
var vec__47525 = p__47524;
var ns_detector = cljs.core.nth.call(null,vec__47525,(0),null);
...
var G__47531 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__47532 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__47531;
remaining_tokens = G__47532;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq47522){
var G__47523 = cljs.core.first.call(null,seq47522);
var seq47522__$1 = cljs.core.next.call(null,seq47522);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47523,seq47522__$1);
}));
...
var vec__47536 = cljs.core.split_with.call(null,(function (p1__47535_SHARP_){
return cljs.core.not_EQ_.call(null,p1__47535_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__47536,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__47536,(1),null);
...
var vec__47542 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__47542,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__47542,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__47545 = cljs.core.rest.call(null,remaining_tokens);
var G__47546 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__47545;
name_tokens = G__47546;
continue;
} else {
...
var vec__47549 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__47549,(0),null);
var arity = cljs.core.nth.call(null,vec__47549,(1),null);
var vec__47552 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__47552,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__47552,(1),null);
var vec__47555 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__47555,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__47555,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__47555,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__47555,(3),null);
...
var vec__47561 = result;
var munged_ns = cljs.core.nth.call(null,vec__47561,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__47561,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__47561,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__47561,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__47561,(4),null);
var arity = cljs.core.nth.call(null,vec__47561,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__47565 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__47565,(0),null);
var args = cljs.core.nth.call(null,vec__47565,(1),null);
var vec__47568 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__47568,(0),null);
var name = cljs.core.nth.call(null,vec__47568,(1),null);
...
var G__47571 = (arity + (1));
var G__47572 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__47573){
var vec__47574 = p__47573;
var arity = cljs.core.nth.call(null,vec__47574,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__47574,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__47577_SHARP_){
return cljs.core.get.call(null,arities,p1__47577_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__47578_SHARP_){
return cljs.core.drop.call(null,(2),p1__47578_SHARP_);
}),sorted_infos);
...
var args__4870__auto__ = [];
var len__4864__auto___47585 = arguments.length;
var i__4865__auto___47586 = (0);
while(true){
if((i__4865__auto___47586 < len__4864__auto___47585)){
args__4870__auto__.push((arguments[i__4865__auto___47586]));

var G__47587 = (i__4865__auto___47586 + (1));
i__4865__auto___47586 = G__47587;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__47581){
var vec__47582 = p__47581;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__47582,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq47579){
var G__47580 = cljs.core.first.call(null,seq47579);
var seq47579__$1 = cljs.core.next.call(null,seq47579);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47580,seq47579__$1);
}));
...
var map__47590 = options;
var map__47590__$1 = cljs.core.__destructure_map.call(null,map__47590);
var include_ns_QMARK_ = cljs.core.get.call(null,map__47590__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__47590__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__47590__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__47590__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__47591 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__47591,(0),null);
var fn_name = cljs.core.nth.call(null,vec__47591,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__47591,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__47591,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__47591,(4),null);
var arity = cljs.core.nth.call(null,vec__47591,(5),null);
...
var o__33982__auto__ = f;
return (o__33982__auto__["getBasis"]).call(o__33982__auto__);
});
/**
...
}catch (e47594){var _e__33989__auto__ = e47594;
...
var G__47595 = (obj[cljs.core.first.call(null,path)]);
var G__47596 = cljs.core.rest.call(null,path);
obj = G__47595;
path = G__47596;
continue;
} else {
...
var _STAR_ = (function (accum,p__47597){
var vec__47598 = p__47597;
var bit = cljs.core.nth.call(null,vec__47598,(0),null);
var protocol = cljs.core.nth.call(null,vec__47598,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__47601){
var vec__47602 = p__47601;
var ns = cljs.core.nth.call(null,vec__47602,(0),null);
var name = cljs.core.nth.call(null,vec__47602,(1),null);
var selector = cljs.core.nth.call(null,vec__47602,(2),null);
...
var post_process = (function (p__47606){
var vec__47607 = p__47606;
var munged_name = cljs.core.nth.call(null,vec__47607,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__47607,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__47605_SHARP_){
return (obj[cljs.core.first.call(null,p1__47605_SHARP_)]);
}),sorted_matches);
