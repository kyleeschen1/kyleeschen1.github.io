...
var o34318 = temp__5718__auto__;
var temp__5718__auto____$1 = (o34318["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o34319 = temp__5718__auto____$1;
return (o34319["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__33982__auto___34322 = t;
(o__33982__auto___34322["cljs$lang$ctorPrWriter"]).call(o__33982__auto___34322,t,writer);
}catch (e34321){var __34323 = e34321;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__34324 = num_code;
switch (G__34324) {
case (1):
return (185);
...
}catch (e34326){var _e__33989__auto__ = e34326;
return false;
}})())){
...
var vec__34327 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__34327,(0),null);
...
var len__4864__auto___34336 = arguments.length;
var i__4865__auto___34337 = (0);
while(true){
if((i__4865__auto___34337 < len__4864__auto___34336)){
args__4870__auto__.push((arguments[i__4865__auto___34337]));

var G__34338 = (i__4865__auto___34337 + (1));
i__4865__auto___34337 = G__34338;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__34332){
var vec__34333 = p__34332;
var ns_detector = cljs.core.nth.call(null,vec__34333,(0),null);
...
var G__34339 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__34340 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__34339;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq34330){
var G__34331 = cljs.core.first.call(null,seq34330);
var seq34330__$1 = cljs.core.next.call(null,seq34330);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34331,seq34330__$1);
}));
...
var vec__34344 = cljs.core.split_with.call(null,(function (p1__34343_SHARP_){
return cljs.core.not_EQ_.call(null,p1__34343_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__34344,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__34344,(1),null);
...
var vec__34350 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__34350,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__34350,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__34353 = cljs.core.rest.call(null,remaining_tokens);
var G__34354 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__34353;
name_tokens = G__34354;
continue;
} else {
...
var vec__34357 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__34357,(0),null);
var arity = cljs.core.nth.call(null,vec__34357,(1),null);
var vec__34360 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__34360,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__34360,(1),null);
var vec__34363 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__34363,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__34363,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__34363,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__34363,(3),null);
...
var vec__34369 = result;
var munged_ns = cljs.core.nth.call(null,vec__34369,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__34369,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__34369,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__34369,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__34369,(4),null);
var arity = cljs.core.nth.call(null,vec__34369,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__34373 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__34373,(0),null);
var args = cljs.core.nth.call(null,vec__34373,(1),null);
var vec__34376 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__34376,(0),null);
var name = cljs.core.nth.call(null,vec__34376,(1),null);
...
var G__34379 = (arity + (1));
var G__34380 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__34381){
var vec__34382 = p__34381;
var arity = cljs.core.nth.call(null,vec__34382,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__34382,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__34385_SHARP_){
return cljs.core.get.call(null,arities,p1__34385_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__34386_SHARP_){
return cljs.core.drop.call(null,(2),p1__34386_SHARP_);
}),sorted_infos);
...
var args__4870__auto__ = [];
var len__4864__auto___34393 = arguments.length;
var i__4865__auto___34394 = (0);
while(true){
if((i__4865__auto___34394 < len__4864__auto___34393)){
args__4870__auto__.push((arguments[i__4865__auto___34394]));

var G__34395 = (i__4865__auto___34394 + (1));
i__4865__auto___34394 = G__34395;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__34389){
var vec__34390 = p__34389;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__34390,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq34387){
var G__34388 = cljs.core.first.call(null,seq34387);
var seq34387__$1 = cljs.core.next.call(null,seq34387);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34388,seq34387__$1);
}));
...
var map__34398 = options;
var map__34398__$1 = cljs.core.__destructure_map.call(null,map__34398);
var include_ns_QMARK_ = cljs.core.get.call(null,map__34398__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__34398__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__34398__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__34398__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__34399 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__34399,(0),null);
var fn_name = cljs.core.nth.call(null,vec__34399,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__34399,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__34399,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__34399,(4),null);
var arity = cljs.core.nth.call(null,vec__34399,(5),null);
...
}catch (e34402){var _e__33989__auto__ = e34402;
...
var G__34403 = (obj[cljs.core.first.call(null,path)]);
var G__34404 = cljs.core.rest.call(null,path);
obj = G__34403;
path = G__34404;
continue;
} else {
...
var _STAR_ = (function (accum,p__34405){
var vec__34406 = p__34405;
var bit = cljs.core.nth.call(null,vec__34406,(0),null);
var protocol = cljs.core.nth.call(null,vec__34406,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__34409){
var vec__34410 = p__34409;
var ns = cljs.core.nth.call(null,vec__34410,(0),null);
var name = cljs.core.nth.call(null,vec__34410,(1),null);
var selector = cljs.core.nth.call(null,vec__34410,(2),null);
...
var post_process = (function (p__34414){
var vec__34415 = p__34414;
var munged_name = cljs.core.nth.call(null,vec__34415,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__34415,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__34413_SHARP_){
return (obj[cljs.core.first.call(null,p1__34413_SHARP_)]);
}),sorted_matches);
