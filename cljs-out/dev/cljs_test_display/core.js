...
var node = cljs_test_display.core.n.call(null,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null),style_string_41514);
...
var len__4864__auto___41518 = arguments.length;
var i__4865__auto___41519 = (0);
while(true){
if((i__4865__auto___41519 < len__4864__auto___41518)){
args__4870__auto__.push((arguments[i__4865__auto___41519]));

var G__41520 = (i__4865__auto___41519 + (1));
i__4865__auto___41519 = G__41520;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq41515){
var G__41516 = cljs.core.first.call(null,seq41515);
var seq41515__$1 = cljs.core.next.call(null,seq41515);
var G__41517 = cljs.core.first.call(null,seq41515__$1);
var seq41515__$2 = cljs.core.next.call(null,seq41515__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41516,G__41517,seq41515__$2);
}));
...
var vec__41521 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__41521,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__41521,(1),null);
var G__41524 = cljs.core.PersistentArrayMap.EMPTY;
var G__41524__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__41524,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__41524);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__41524__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__41524__$1;
}
} else {
...
return (function() { 
var G__41528__delegate = function (klass,contents){
var vec__41525 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__41525,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__41525,(1),null);
...
var G__41528 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__41529__i = 0, G__41529__a = new Array(arguments.length -  1);
while (G__41529__i < G__41529__a.length) {G__41529__a[G__41529__i] = arguments[G__41529__i + 1]; ++G__41529__i;}
  contents = new cljs.core.IndexedSeq(G__41529__a,0,null);
} 
return G__41528__delegate.call(this,klass,contents);};
G__41528.cljs$lang$maxFixedArity = 1;
G__41528.cljs$lang$applyTo = (function (arglist__41530){
var klass = cljs.core.first(arglist__41530);
var contents = cljs.core.rest(arglist__41530);
return G__41528__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__41534){
var map__41535 = p__41534;
var map__41535__$1 = cljs.core.__destructure_map.call(null,map__41535);
var ns = cljs.core.get.call(null,map__41535__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__41535__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__41536){
var map__41537 = p__41536;
var map__41537__$1 = cljs.core.__destructure_map.call(null,map__41537);
var actual = cljs.core.get.call(null,map__41537__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__41537__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__41538){
var map__41539 = p__41538;
var map__41539__$1 = cljs.core.__destructure_map.call(null,map__41539);
var expected = cljs.core.get.call(null,map__41539__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__41539__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__41540_SHARP_){
return cljs.core.cons.call(null,new_current_node,p1__41540_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__41542 = cljs_test_display.core.current_var_info.call(null);
var map__41542__$1 = cljs.core.__destructure_map.call(null,map__41542);
var info = map__41542__$1;
var name = cljs.core.get.call(null,map__41542__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__41542__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__41542__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__41541_SHARP_){
return cljs.core.cons.call(null,node,p1__41541_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__41543){
var map__41544 = p__41543;
var map__41544__$1 = cljs.core.__destructure_map.call(null,map__41544);
var m = map__41544__$1;
var fail = cljs.core.get.call(null,map__41544__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__41544__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__41544__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__41544__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5720__auto___41545 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___41545)){
var message_41546 = temp__5720__auto___41545;
cljs.core.println.call(null,message_41546);
} else {
}
...
var temp__5720__auto___41547 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___41547)){
var message_41548 = temp__5720__auto___41547;
cljs.core.println.call(null,message_41548);
} else {
}
