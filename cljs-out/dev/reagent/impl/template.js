...
var G__10948_10951 = reagent.impl.template.prop_name_cache;
var G__10949_10952 = cljs.core.name(k);
var G__10950_10953 = v;
reagent.impl.template.goog$module$goog$object.set.call(null,G__10948_10951,G__10949_10952,G__10950_10953);
...
var G__10954 = o;
var G__10955_10958 = G__10954;
var G__10956_10959 = reagent.impl.template.cached_prop_name(k);
var G__10957_10960 = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v));
reagent.impl.template.goog$module$goog$object.set.call(null,G__10955_10958,G__10956_10959,G__10957_10960);
...
while (G__10962__i < G__10962__a.length) {G__10962__a[G__10962__i] = arguments[G__10962__i + 0]; ++G__10962__i;}
  args = new cljs.core.IndexedSeq(G__10962__a,0,null);
} 
...
if((temp__5722__auto__ == null)){
var v = reagent.impl.util.dash_to_prop_name(k);
var G__10964_10967 = reagent.impl.template.custom_prop_name_cache;
var G__10965_10968 = cljs.core.name(k);
var G__10966_10969 = v;
reagent.impl.template.goog$module$goog$object.set.call(null,G__10964_10967,G__10965_10968,G__10966_10969);
...
var G__10970 = o;
var G__10971_10974 = G__10970;
var G__10972_10975 = reagent.impl.template.cached_custom_prop_name(k);
var G__10973_10976 = reagent.impl.template.convert_prop_value(v);
reagent.impl.template.goog$module$goog$object.set.call(null,G__10971_10974,G__10972_10975,G__10973_10976);
...
var G__10980 = props;
var G__10980__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10980,cljs.core.cst$kw$id,id):G__10980);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10980__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__10981 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10981,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__10981;
}
})(),id_class);
...
var G__10982 = (cljs.core.count(argv) - first_child);
switch (G__10982) {
case (0):
...
break;
case (1):
var G__10983 = component;
var G__10984 = jsprops;
var G__10985 = reagent.impl.protocols.as_element(this$,cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return reagent.impl.template.global$module$react.createElement(G__10983,G__10984,G__10985);
...
var vec__10987 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10987,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10987,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10987,(2),null);
...
var temp__5724__auto___10990 = reagent.impl.util.react_key_from_vec(v);
if((temp__5724__auto___10990 == null)){
} else {
var key_10991 = temp__5724__auto___10990;
(jsprops.key = key_10991);
}
...
var temp__5724__auto___10994 = reagent.impl.util.react_key_from_vec(v);
if((temp__5724__auto___10994 == null)){
} else {
var key_10995 = temp__5724__auto___10994;
(jsprops.key = key_10995);
}

var G__10992 = reagent.impl.component.functional_render_fn(compiler,tag);
var G__10993 = jsprops;
return reagent.impl.template.global$module$react.createElement(G__10992,G__10993);
});
/**
...
var temp__5724__auto___10996 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5724__auto___10996 == null)){
} else {
var key_10997 = temp__5724__auto___10996;
(jsprops.key = key_10997);
}
...
var temp__5724__auto___10998 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5724__auto___10998 == null)){
} else {
var key_10999 = temp__5724__auto___10998;
(jsprops.key = key_10999);
}
...
var temp__5724__auto___11000 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5724__auto___11000 == null)){
} else {
var key_11001 = temp__5724__auto___11000;
(jsprops.key = key_11001);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__11002_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__11002_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__11003 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11003,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11003,(1),null);
...
break;
default:
var G__11008 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__11009 = compiler;
v = G__11008;
compiler = G__11009;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template11013 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template11013 = (function (opts,id,fn_to_element,parse_fn,meta11014){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template11013.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11015,meta11014__$1){
var self__ = this;
var _11015__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template11013(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta11014__$1));
}));

(reagent.impl.template.t_reagent$impl$template11013.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11015){
var self__ = this;
var _11015__$1 = this;
return self__.meta11014;
}));

(reagent.impl.template.t_reagent$impl$template11013.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template11013.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template11013.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template11013.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template11013.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template11013.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$opts,cljs.core.cst$sym$id,cljs.core.cst$sym$fn_DASH_to_DASH_element,cljs.core.cst$sym$parse_DASH_fn,cljs.core.cst$sym$meta11014], null);
}));

(reagent.impl.template.t_reagent$impl$template11013.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template11013.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template11013");

(reagent.impl.template.t_reagent$impl$template11013.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template11013");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template11013.
 */
reagent.impl.template.__GT_t_reagent$impl$template11013 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template11013(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta11014){
return (new reagent.impl.template.t_reagent$impl$template11013(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta11014));
});

}

return (new reagent.impl.template.t_reagent$impl$template11013(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
