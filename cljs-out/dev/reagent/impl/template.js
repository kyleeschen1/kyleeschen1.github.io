...
var G__38451 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__38451,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__38452__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__38452 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__38453__i = 0, G__38453__a = new Array(arguments.length -  0);
while (G__38453__i < G__38453__a.length) {G__38453__a[G__38453__i] = arguments[G__38453__i + 0]; ++G__38453__i;}
  args = new cljs.core.IndexedSeq(G__38453__a,0,null);
} 
return G__38452__delegate.call(this,args);};
G__38452.cljs$lang$maxFixedArity = 0;
G__38452.cljs$lang$applyTo = (function (arglist__38454){
var args = cljs.core.seq(arglist__38454);
return G__38452__delegate(args);
});
...
var G__38455 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__38455,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__38456__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__38456 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__38457__i = 0, G__38457__a = new Array(arguments.length -  0);
while (G__38457__i < G__38457__a.length) {G__38457__a[G__38457__i] = arguments[G__38457__i + 0]; ++G__38457__i;}
  args = new cljs.core.IndexedSeq(G__38457__a,0,null);
} 
return G__38456__delegate.call(this,args);};
G__38456.cljs$lang$maxFixedArity = 0;
G__38456.cljs$lang$applyTo = (function (arglist__38458){
var args = cljs.core.seq(arglist__38458);
return G__38456__delegate(args);
});
...
var G__38459 = props;
var G__38459__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__38459,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__38459);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__38459__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__38460 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__38460,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__38460;
}
})(),id_class);
...
var vec__38463 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__38463,(0),null);
var id = cljs.core.nth.call(null,vec__38463,(1),null);
var className = cljs.core.nth.call(null,vec__38463,(2),null);
...
var temp__5724__auto___38466 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5724__auto___38466 == null)){
} else {
var key_38467 = temp__5724__auto___38466;
(jsprops.key = key_38467);
}
...
var temp__5724__auto___38468 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5724__auto___38468 == null)){
} else {
var key_38469 = temp__5724__auto___38468;
(jsprops.key = key_38469);
}
...
var temp__5724__auto___38470 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5724__auto___38470 == null)){
} else {
var key_38471 = temp__5724__auto___38470;
...
var temp__5724__auto___38472 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5724__auto___38472 == null)){
} else {
var key_38473 = temp__5724__auto___38472;
(jsprops.key = key_38473);
}
...
var temp__5724__auto___38474 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5724__auto___38474 == null)){
} else {
var key_38475 = temp__5724__auto___38474;
(jsprops.key = key_38475);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__38476_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__38476_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__38477 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__38477,(0),null);
var derefed = cljs.core.nth.call(null,vec__38477,(1),null);
...
break;
default:
var G__38482 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__38483 = compiler;
v = G__38482;
compiler = G__38483;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template38487 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template38487 = (function (opts,id,fn_to_element,parse_fn,meta38488){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template38487.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_38489,meta38488__$1){
var self__ = this;
var _38489__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template38487(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta38488__$1));
}));

(reagent.impl.template.t_reagent$impl$template38487.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_38489){
var self__ = this;
var _38489__$1 = this;
return self__.meta38488;
}));

(reagent.impl.template.t_reagent$impl$template38487.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template38487.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template38487.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template38487.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template38487.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template38487.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta38488","meta38488",-1012916370,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template38487.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template38487.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template38487");

(reagent.impl.template.t_reagent$impl$template38487.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write.call(null,writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template38487");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template38487.
 */
reagent.impl.template.__GT_t_reagent$impl$template38487 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template38487(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta38488){
return (new reagent.impl.template.t_reagent$impl$template38487(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta38488));
});

}

return (new reagent.impl.template.t_reagent$impl$template38487(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
