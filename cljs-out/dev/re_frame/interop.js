...
return [(function (){var pred__18099 = cljs.core.instance_QMARK_;
var expr__18100 = reactive_val;
if(cljs.core.truth_(pred__18099.call(null,reagent.ratom.RAtom,expr__18100))){
return "ra";
} else {
if(cljs.core.truth_(pred__18099.call(null,reagent.ratom.RCursor,expr__18100))){
return "rc";
} else {
if(cljs.core.truth_(pred__18099.call(null,reagent.ratom.Reaction,expr__18100))){
return "rx";
} else {
if(cljs.core.truth_(pred__18099.call(null,reagent.ratom.Track,expr__18100))){
return "tr";
} else {
return "other";
}
