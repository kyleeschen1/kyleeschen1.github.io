...
return [(function (){var pred__38681 = cljs.core.instance_QMARK_;
var expr__38682 = reactive_val;
if(cljs.core.truth_(pred__38681.call(null,reagent.ratom.RAtom,expr__38682))){
return "ra";
} else {
if(cljs.core.truth_(pred__38681.call(null,reagent.ratom.RCursor,expr__38682))){
return "rc";
} else {
if(cljs.core.truth_(pred__38681.call(null,reagent.ratom.Reaction,expr__38682))){
return "rx";
} else {
if(cljs.core.truth_(pred__38681.call(null,reagent.ratom.Track,expr__38682))){
return "tr";
} else {
return "other";
}
