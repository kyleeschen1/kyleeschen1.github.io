...
if(cljs.core.seq(m)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__10110){
...
var vec__10114 = clojure.data.diff(va,vb);
var a_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10114,(0),null);
var b_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10114,(1),null);
var ab = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10114,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_10120 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_10120(x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_10121 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_10121(a,b);
}
});
...
var fexpr__10126 = (function (){var G__10127 = clojure.data.equality_partition(a);
var G__10127__$1 = (((G__10127 instanceof cljs.core.Keyword))?G__10127.fqn:null);
switch (G__10127__$1) {
case "atom":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10127__$1)].join('')));

}
})();
return (fexpr__10126.cljs$core$IFn$_invoke$arity$2 ? fexpr__10126.cljs$core$IFn$_invoke$arity$2(a,b) : fexpr__10126.call(null,a,b));
}));
/**
