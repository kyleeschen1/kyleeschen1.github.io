...
var G__103843 = arguments.length;
switch (G__103843) {
case 1:
...
var G__103846 = arguments.length;
switch (G__103846) {
case 1:
...
var G__103849 = arguments.length;
switch (G__103849) {
case 1:
...
if(cljs.tools.reader.reader_types.source_logging_reader_QMARK_.call(null,reader)){
var buf_103851 = edamame.impl.parser.buf.call(null,reader);
buf_103851.clear();
} else {
}
...
var or__4253__auto__ = cljs.core.get.call(null,opts,new cljs.core.Keyword(null,"eof","eof",-489063237));
