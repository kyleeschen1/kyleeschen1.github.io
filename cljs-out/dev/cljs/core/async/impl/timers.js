...
while(true){
if((i <= self__.level)){
var links_17895 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_17895[i]));
} else {
x__$2.forward.push((((i < links_17895.length))?(links_17895[i]):null));
}

if((i < links_17895.length)){
(links_17895[i] = x__$2);
} else {
links_17895.push(x__$2);
}
...
if((x__$1 === (((i_17897 < links_17898.length))?(links_17898[i_17897]):null))){
